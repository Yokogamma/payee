...
**Заметки, которые живут вечно** — как черепаха матамата. Зашифрованы. Неудаляемы.
...
Живое приложение: <https://notes.matamata.dev>

*Матамата (Chelus fimbriata) — символ проекта: долгожитель под панцирем
(шифрование), мастер маскировки (без ключа заметки неотличимы от шума).
Слово зеркально — mata|mata — как две петли знака ∞.*
