...
describe('parseHash', () => {
  ...
  it('degrades an unknown section to the default instead of rendering nothing', () => {
    // The rollback case: a newer build wrote #/settings, this one has no such
    // section. Falling back beats a blank screen.
    expect(parseHash('#/settings')).toBe(DEFAULT_SECTION);
